...
const char* longit = "40.29";
const char* latit = "-74.72";


// Weather API URL
const char* weather_url = "https://api.open-meteo.com/v1/forecast?latitude=" + longit + "&longitude=" + latit "&current=temperature_2m,weathercode&timezone=auto&temperature_unit=fahrenheit";
